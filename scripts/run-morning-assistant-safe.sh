...
HERMES_AGENT_TEST_DIR="${HERMES_AGENT_TEST_DIR:-$HOME/Projects/hermes-agent-test}"
HERMES_KNOWN_PATH="${HERMES_BIN:-$HERMES_AGENT_TEST_DIR/home/.local/bin/hermes}"
GOOGLE_HERMES_USER_HOME="${HERMES_TEST_HOME:-$HERMES_AGENT_TEST_DIR/home}"
GOOGLE_HERMES_HOME="${HERMES_HOME:-$HERMES_AGENT_TEST_DIR/home/.hermes}"
